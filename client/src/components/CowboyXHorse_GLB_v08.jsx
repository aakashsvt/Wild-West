...
Command: npx gltfjsx@6.5.3 CowboyXHorse_GLB_v08.glb 
*/
...
export const Model1 = forwardRef((props, ref) => {
  const group = React.useRef();
  const { scene, animations } = useGLTF("/models/CowboyXHorse_GLB_V08.glb");
